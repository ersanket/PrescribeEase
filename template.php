...
<h1>Fill Template</h1>
    <form action="generate_pdf.php" method="post">
        ...
        <?php if ($template == 'eprescription'): ?>
            <h2>E-Prescription</h2>
            <textarea name="content" placeholder="Enter prescription details"></textarea>
        <?php elseif ($template == 'medicalcertificate'): ?>
            <h2>Medical Certificate</h2>
            <div class="form-group">
                <label for="ip_mr_no">IP/Mr. No:</label>
                <input type="text" name="ip_mr_no" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="ward_bed" required>
            </div>
            <div class="form-group">
                <label for="date_of_operation">Date Of Operation:</label>
                <input type="date" name="date_of_operation" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" name="date_of_discharge" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="diagnosis_remark">Diagnosis/Remark:</label>
                <textarea name="diagnosis_remark" required></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="vitals" required></textarea>
            </div>
            <div class="form-group">
                <label for="treatment_given">Treatment Given:</label>
                <textarea name="treatment_given" required></textarea>
            </div>
            <div class="form-group">
                <label for="condition_during_discharge">Condition During Discharge:</label>
                <textarea name="condition_during_discharge" required></textarea>
            </div>
            <div class="form-group">
                <label for="advice_on_discharge">Advice On Discharge:</label>
                <textarea name="advice_on_discharge" required></textarea>
            </div>
        <?php elseif ($template == 'medicinedetails'): ?>
            <h2>Medicine Details</h2>
            <textarea name="content" placeholder="Enter medicine details"></textarea>
        <?php elseif ($template == 'patientdetails'): ?>
            <h2>Patient Details</h2>
            <textarea name="content" placeholder="Enter patient details"></textarea>
        <?php endif; ?>
